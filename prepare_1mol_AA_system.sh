...
gmx_mpi insert-molecules -ci $solute -nmol 1 -box 3.8 3.8 3.8 -rot xyz -seed 0 -o out.gro

gmx_mpi solvate -cp out.gro -cs $solvent_box -o initial.gro
...
gmx_mpi grompp -p system.top -c initial.gro -f em.mdp  -o 1-min.tpr -po 1-min.mdp 
gmx_mpi mdrun -v -deffnm 1-min >> mdrun.log 2>&1

gmx_mpi grompp -p system.top -c 1-min.gro   -f eq.mdp  -o 2-eq.tpr  -po 2-eq.mdp 
gmx_mpi mdrun -v -deffnm 2-eq  >> mdrun.log 2>&1

gmx_mpi grompp -p system.top -c 2-eq.gro    -f run.mdp -o 3-run.tpr -po 3-run.mdp 
gmx_mpi mdrun -v -deffnm 3-run >> mdrun.log 2>&1
